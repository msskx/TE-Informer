...
from models.encoder import ConvLayer, EncoderLayer, Encoder
from utils.time_encode import TrigonometricEncoding
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
class TEInformer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len,
                 factor=5, d_model=512, n_heads=8, e_layers=3, d_layers=2, d_ff=512,
                 dropout=0.0, attn='prob', embed='fixed', freq='h', activation='gelu',
                 output_attention=False, distil=True, mix=True,
                 device=torch.device('cuda:0')):
        super(TEInformer, self).__init__()
        ...
        # Encoder
        self.time = TrigonometricEncoding(d_model)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        # insert time encoding
        enc_out = self.time(x_enc)
